...
- [#OSWGuilds: Scrum y Cultura de equipos en proyectos Open Source](https://slides.com/tebagomez/guilds-scrum-agile)
- [Say “agile” one more time](https://tisquirrel.me/2016/01/03/say-agile-one-more-time/)
- [Manifiesto por el Desarrollo Ágil de Software](http://agilemanifesto.org/iso/es/)
- [#Scrum (desarrollo de software) en Wikipedia](https://es.wikipedia.org/wiki/Scrum_(desarrollo_de_software))
- [#XP Programación extrema en Wikipedia](https://es.wikipedia.org/wiki/Programaci%C3%B3n_extrema)
